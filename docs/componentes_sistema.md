...
O app define a versao em `main/app_firmware_version.h`:

```c
#define APP_FIRMWARE_VERSION_SEMVER "0.5.03"
#define APP_FIRMWARE_VERSION_LABEL "WiFi system refactor"
```

`firmware_version.h` expoe as macros usadas pelos componentes:
